	...
	tests := []struct {
	...
	}{
		{
			...
			[]Attr{
				AttrBold,
				AttrStrikethrough,
				AttrFgColor4BitsBlack,
				AttrBgColor4BitsBrightCyan,
			},
		...
		},
		{
			...
			[]Attr{
				AttrItalic,
				AttrBlink,
				AttrFgColor4BitsBrightBlack,
				AttrBgColor4BitsBlue,
			},
		...
		},
		{
			...
			[]Attr{
				AttrBold,
				AttrBlink,
				AttrFgColor4BitsYellow,
				AttrBgColor4BitsWhite,
			},
		...
		},
		{
			...
			[]Attr{
				AttrUnderline,
				AttrFgColor24Bits(255, 0, 0),
				AttrBgColor24Bits(0, 0, 255),
			},
